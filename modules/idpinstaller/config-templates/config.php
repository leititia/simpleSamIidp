...
$config = [
 ...
 139 contributors
 View license
 PHP 94.9%	 HTML 2.9%	 CSS 1.5%	 JavaScript 0.4%	 Shell 0.2%	 Perl 0.1%￼
PHP
HTML
CSS
JavaScript
...
Clone or download 
￼
thijskh Small documentation updates.
Latest commit 849c7d3  1 hour ago
Type	Name	Latest commit message	Commit time
.github/ISSUE_TEMPLATE	Update issue templates	last year
attributemap	Converted array declarations (#959)	last year
bin	Externalize exampleattributeserver (#1131)	5 days ago
cache	Start of Twigification	3 years ago
config-templates	Remove authlinkedin from repository; LinkedIn no longer supports oAuth1	14 days ago
config	Added .gitkeep files to track empty folders.	4 years ago
dictionaries	updated catalan translations (#1116)	18 days ago
docs	Small documentation updates.	1 hour ago
extra	Start using the external module for authmemcookie	this year
