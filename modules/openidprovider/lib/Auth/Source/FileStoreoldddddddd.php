...
require_once dirname( __DIR__ ) . '/Source/Auth/OpenID.php';
require_once dirname( __DIR__ ) . '/Source/Auth/OpenID/Store.php';
require_once dirname( __DIR__ ) . '/Source/Auth/OpenID/HMAC.php';
require_once dirname( __DIR__ ) . '/Source/Auth/OpenID/Nonce.php';
