 ...
 */
require_once  dirname( __DIR__ ) . '/Yadis/PlainHTTPFetcher.php';
require_once  dirname( __DIR__ ) . '/Yadis/ParanoidHTTPFetcher.php';

/**
 * Need this for parsing HTML (looking for META tags).
 */
require_once  dirname( __DIR__ ) . '/Yadis/ParseHTML.php';
