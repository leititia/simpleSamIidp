<?php
namespace SimpleSAML\Module\openidprovider\Auth\Source\Auth;
/**
 ...
 */
require_once dirname( __DIR__ ) . '/Auth/Yadis/PlainHTTPFetcher.php';
require_once dirname( __DIR__ ) . '/Auth/Yadis/ParanoidHTTPFetcher.php';
...
class OpenID {
    ...
    static function arrayGet($arr, $key, $fallback = null)
    {
        if (is_array($arr)) {
            ...
            trigger_error("OpenID::arrayGet (key = ".$key.") expected " .
    ...
    static function normalizeUrl($url)
    {
        ...
        list($defragged) = OpenID::urldefrag($normalized);
        return $defragged;
    }
