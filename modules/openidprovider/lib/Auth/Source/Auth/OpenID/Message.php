...
require_once dirname( __DIR__ ) . '/Yadis/XML.php';
require_once 'Consumer.php'; // For Auth_OpenID_FailureResponse
...
function registerNamespaceAlias($namespace_uri, $alias)
{
    ...
    if (\SimpleSAML\Module\openidprovider\Auth\Source\Auth\OpenID::arrayGet($Auth_OpenID_registered_aliases,
                              $alias) == $namespace_uri) {
        return true;
    }
