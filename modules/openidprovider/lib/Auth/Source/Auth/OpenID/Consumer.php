...
require_once dirname( __DIR__ ) . '/OpenID/Discover.php';
require_once dirname( __DIR__ ) . '/OpenID/URINorm.php';
require_once dirname( __DIR__ ) . '/Yadis/Manager.php';
require_once dirname( __DIR__ ) . '/Yadis/XRI.php';
...
class Auth_OpenID_Consumer {
     ...
     *
     * @param Store $store This must be an object
     * that implements the interface in {@link
     * Store}.  Several concrete implementations are
...
class Auth_OpenID_GenericConsumer {
     ...
     *
     * @param Store $store This must be an object
     * that implements the interface in {@link Store}.
...
class Auth_OpenID_AuthRequest {
     ...
     *
     * @param Extension $extension_request An object that implements the extension
