 ...
 * @version $Id$
 */
class ProviderServer  extends \SimpleSAML\Auth\Source
{
    /**
    ...
    public function __construct()
    {
        ...
        try {
            $store = new FileStore($config->getString('filestore'));
            $this->server = new Store($store, $this->getServerURL());
    ...
    public function authenticate(&$state) {
        ...
        $stateId = Auth\State::saveState($state, 'authinwebo:InWebo');
