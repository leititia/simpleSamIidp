...
class Store {
    ...
    {
        trigger_error("Store::storeAssociation not implemented", E_USER_ERROR);
    }
    ...
    {
        trigger_error("Store::cleanupNonces not implemented", E_USER_ERROR);
        return 0;
    }
    ...
    {
        trigger_error("Store::cleanupAssociations not implemented", E_USER_ERROR);
        return 0;
    }
    ...
    {
        trigger_error("Store::getAssociation not implemented", E_USER_ERROR);
        return null;
    }
    ...
    {
        trigger_error("Store::removeAssociation not implemented", E_USER_ERROR);
        return null;
    }
    ...
    {
        trigger_error("Store::useNonce not implemented", E_USER_ERROR);
        return false;
    }
