 ...
 * Server::decodeRequest()} and {@link
 * Server::encodeResponse} methods.  Who gets to do the
 ...
 * communications.  {@link Server} contains all the logic
 * and data necessary to respond to such requests; just pass it to
 * {@link Server::handleRequest()}.
 *
 * OpenID Extensions
 *
 ...
 * ServerResponse} provides methods with which you can add
...
require_once dirname( __DIR__ ) . '/OpenID.php';
require_once dirname( __DIR__ ) . '/OpenID/Association.php';
require_once dirname( __DIR__ ) . '/OpenID/CryptUtil.php';
require_once dirname( __DIR__ ) . '/OpenID/BigMath.php';
require_once dirname( __DIR__ ) . '/OpenID/DiffieHellman.php';
require_once dirname( __DIR__ ) . '/OpenID/KVForm.php';
require_once dirname( __DIR__ ) . '/OpenID/TrustRoot.php';
require_once dirname( __DIR__ ) . '/OpenID/ServerRequest.php';
require_once dirname( __DIR__ ) . '/OpenID/Message.php';
require_once dirname( __DIR__ ) . '/OpenID/Nonce.php';
 ...
 * @return bool
 */
function Auth_OpenID_isError($obj, $cls = 'ServerError')
{
    return is_a($obj, $cls);
}
 ...
 * @package OpenID
 */
class Auth_OpenID_NoReturnToError extends ServerError {
 ...
 * @package OpenID
 */
class Auth_OpenID_MalformedReturnURL extends ServerError {
 ...
 * @package OpenID
 */
class Auth_OpenID_MalformedTrustRoot extends ServerError {
    function __construct($message = null,
...
class Auth_OpenID_CheckAuthRequest extends Auth_OpenID_Request {
    ...
    /**
     * @param Auth_OpenID_Message $message
     * @return Auth_OpenID_CheckAuthRequest|ServerError
     */
    ...
    function answer($signatory)
    {
        ...
        $response = new ServerResponse($this);
...
class Auth_OpenID_AssociateRequest extends Auth_OpenID_Request {
    ...
    /**
     * @param Auth_OpenID_Message $message
     * @return Auth_OpenID_AssociateRequest|ServerError|mixed
     */
    static function fromMessage($message)
    {
                               ...
                               $preferred_session_type=null)
    {
        if ($this->message->isOpenID1()) {
            return new ServerError($this->message);
        }
...
class Auth_OpenID_CheckIDRequest extends Auth_OpenID_Request {
     ...
     * @param Server $server
     * @return Auth_OpenID_CheckIDRequest|Auth_OpenID_MalformedReturnURL|ServerError|Auth_OpenID_UntrustedReturnURL
     */
    ...
    static function fromMessage($message, $server)
    {
        ...
        if (($message->isOpenID1()) &&
            ...
            return new ServerError($message, $fmt);
        }
        ...
        if ($message->isOpenID1()) {
            if ($identity === null) {
                ...
                return new ServerError($message, $s);
            }
        } else {
     ...
     * the {@link Server} constructor makes this optional.
     *
...
class ServerResponse {
    ...
    /**
     * @param Extension $extension_response
     */
...
class Auth_OpenID_Signatory {
     ...
     * @return Auth_OpenID_Association|ServerError|null
     */
...
/**
 * Encode an {@link ServerResponse} to an
...
class Auth_OpenID_Encoder {
    ...
    /**
     * Encode an {@link ServerResponse} and return an
     * {@link Auth_OpenID_WebResponse}.
     *
     * @param ServerResponse $response
...
class Auth_OpenID_SigningEncoder extends Auth_OpenID_Encoder {
    ...
    /**
     * Sign an {@link ServerResponse} and return an
     * {@link Auth_OpenID_WebResponse}.
     *
     * @param ServerResponse $response
     * @return Auth_OpenID_AlreadySigned|Auth_OpenID_EncodingError|ServerError
     */
    function encode($response)
    {
...
class Auth_OpenID_Decoder {
    ...
    function decode($query)
    {
        ...
        if (!is_a($handlerCls, 'ServerError')) {
 ...
 * @package OpenID
 */
class Auth_OpenID_UntrustedReturnURL extends ServerError {
 ...
 *
 * All my state is encapsulated in an {@link Store}.
 *
 * Example:
 *
 * <pre> $oserver = new Server(Auth_OpenID_FileStore($data_path),
 *                                   "http://example.com/op");
...
class Server {
     ...
     * call the appropriate {@link Server} method to
     * process the request and generate a response.
     *
     * @param Auth_OpenID_Request $request An {@link Auth_OpenID_Request}
     * returned by {@link Server::decodeRequest()}.
     *
     * @return ServerResponse $response A response object
