...
require_once dirname( __DIR__ ) . '/Auth/OpenID.php';
require_once dirname( __DIR__ ) . '/Interface.php';
require_once dirname( __DIR__ ) . '/HMAC.php';
require_once dirname( __DIR__ ) . '/Nonce.php';
